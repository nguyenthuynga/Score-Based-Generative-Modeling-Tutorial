...
class UNet_Tranformer_attrb1(nn.Module):
    ...
    def __init__(self, marginal_prob_std, channels=[32, 64, 128, 256], embed_dim=256,
        ...
        self.conv1 = nn.Conv2d(2, channels[0], 3, stride=1, bias=False)#change 25a: making 2 instead of 9 as Mahima code
        ...
        self.tconv4 = nn.ConvTranspose2d(channels[3], channels[2], 3, stride=2, bias=False, output_padding=(1,1)) #change 25b: add padding here
